...
export const projects: Project[] = [
  {
    ...
    description:
      'ShotGlass is a simple, mental refreshment app that allows the user to tailor their own timed meditative experience by selecting from a pool of randomly-generated affirmations & visual- and audio-themes.',
  ...
  },
  {
    ...
    title: 'Weather App',
    description:
      'The weather dashboard app allows the user to bring up the weather forecast for today as well as the next five days for the city entered into the search field.',
    imageUrl:
      'https://github.com/tabouzeid/weather_dashboard/blob/master/assets/img/app_screenshot.png?raw=true',
    bgColor: 'goldenrod',
  ...
  },
  {
    ...
    description:
      'The burger challenge app allows the user to add a new burger to the Queued list and then Devour them and move them to the devoured list. This app is deployed on Heroku and uses JAWS Db in the background to store all of the burgers as well as whether they are devoured or not.',
    imageUrl:
      'https://github.com/tabouzeid/burger_challenge/raw/master/public/assets/img/app_screenshot.png',
  ...
  },
  {
    ...
    imageUrl:
      'https://github.com/tabouzeid/google_book_search/blob/master/public/assets/images/app_screenshot.png?raw=true',
    bgColor: 'bronze',
